 ...
 * @brief              Concatena dirname a pathname separandoli, se necessario, 
 *                     con '/' e se esiste già nel file system un file con il path così costruito aggiunge prima 
 *                     dell'estensione, o alla file del nome se l'estensione non è presente, un numero progressivo 
 *                     tra parentesi tonde , fino a individuare un path non esistente o fino ad aver raggiunto 
 *                     MAX_FILE_VERSION (ad esempio se dir_name vale "./dir" e file_name vale "file.txt" ed esistono già i 
 *                     file "./dir/file.txt"  e "./dir/file(2).txt" restituisce ./dir/file(3).txt)
 * 
