 ...
 *                            in caso di fallimento. In caso di fallimento errno viene settato e può assumere i seguenti 
 *                            valori:
 *                            EINVAL se ht è @c NULL o key è @c NULL .
 */
 ...
 *                            Se free_value è diverso da @c NULL utilizza tale funzione per deallocare il valore associato a
 *                            key.
 * 
 * @param ht                  Oggetto che rappresenta la tabella hash
 ...
 *                            Se free_key() è diversa da @c NULL utilizza tale funzione per deallocare la chiave uguale a 
 *                            key.
 * 
 * @param ht                  Oggetto che rappresenta la tabella hash
 * @param key                 Chiave che si intende eliminare dalla tabella
